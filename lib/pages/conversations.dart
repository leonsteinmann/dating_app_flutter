...
import 'package:datingapp/pages/chat.dart';
...
class _ConversationsPageState extends State<ConversationsPage> {
  ...
  void _onDeclineConversation(String idConversation) async {
    final declineConversationRequest =
    ...
    print(message);
    await declineConversationRequest(message).then((result) => {
          print(result),
        });
  }
    ...
    return Column(
      ...
      children: [
        ListTile(
          ...
          trailing: (conversation.accepted!)
              ? Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                          fontSize: 10.0, color: explanationTextColor),
                    ),
                    SizedBox(
                    ...
                    SizedBox(
                      width: 15,
                      height: 15,
                      child: (!(conversation.lastMessage!.read!) &&
                              FirebaseAuth.instance.currentUser!.uid ==
              ...
              : SizedBox(
                  width: 100,
                  height: 50,
                  child: (conversation.lastMessage!.idFrom == currUserId)
                      ? Column(
                          children: [
